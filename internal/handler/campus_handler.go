...
func NewCampusHandler(svc *campus.Service) *campusHandler {
...
func (h *campusHandler) Delete(c *gin.Context) {
...
func (h *campusHandler) GetListByPage(c *gin.Context) {
...
func (h *campusHandler) GetDetail(c *gin.Context) {
	id := c.Query("id")
	if id == "" {
...
func (h *campusHandler) GetAll(c *gin.Context) {
