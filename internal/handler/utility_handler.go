...
func NewUtilityHandler(svc *utility.Service) *utilityHandler {
...
func (h *utilityHandler) GetListByPage(c *gin.Context) {
...
func (h *utilityHandler) GetDetail(c *gin.Context) {
	id := c.Query("id")
	if id == "" {
...
func (h *utilityHandler) Pay(c *gin.Context) {
	var req dto.UtilityPayReq
	if !utils.ShouldBind(c, &req) {
		return
	}

	if err := h.svc.Pay(&req); err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *utilityHandler) BatchPay(c *gin.Context) {
	var req dto.UtilityBatchPayReq
	if !utils.ShouldBind(c, &req) {
		return
	}

	if err := h.svc.BatchPay(&req); err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *utilityHandler) UpdatePrice(c *gin.Context) {
	var req dto.UtilityPriceReq
	if !utils.ShouldBind(c, &req) {
		return
	}

	if err := h.svc.UpdatePrice(&req); err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *utilityHandler) GetPrice(c *gin.Context) {
	res, err := h.svc.GetPrice()
	if err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *utilityHandler) GetStatistics(c *gin.Context) {
	...
	res, err := h.svc.GetStatistics(campusID, year, month)
	if err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *utilityHandler) GetUnpaidWarning(c *gin.Context) {
	res, err := h.svc.GetUnpaidWarning()
	if err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *utilityHandler) GetUserDormUtility(c *gin.Context) {
	...
	res, err := h.svc.GetUserDormUtility(userID.(string), year, month)
	if err != nil {
		utils.Fail(c, err.Error())
		return
	}
