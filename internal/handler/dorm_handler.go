...
func NewDormHandler(svc *dorm.Service) *dormHandler {
	return &dormHandler{svc: svc}
}
...
func (h *dormHandler) Create(c *gin.Context) {
...
func (h *dormHandler) Update(c *gin.Context) {
...
func (h *dormHandler) Delete(c *gin.Context) {
...
func (h *dormHandler) GetListByPage(c *gin.Context) {
...
func (h *dormHandler) GetDetail(c *gin.Context) {
	id := c.Query("id")
	if id == "" {
...
func (h *dormHandler) AssignDorm(c *gin.Context) {
	var req dto.DormAssignReq
	if !utils.ShouldBind(c, &req) {
		return
	}

	if err := h.svc.AssignDorm(&req); err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *dormHandler) TransferDorm(c *gin.Context) {
	var req dto.DormTransferReq
	if !utils.ShouldBind(c, &req) {
		return
	}

	if err := h.svc.TransferDorm(&req); err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *dormHandler) CheckOut(c *gin.Context) {
	var req dto.DormCheckOutReq
	if !utils.ShouldBind(c, &req) {
		return
	}

	if err := h.svc.CheckOut(&req); err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *dormHandler) GetDormUsers(c *gin.Context) {
	var req dto.DormUserListReq
	if !utils.ShouldBind(c, &req) {
		return
	}

	res, err := h.svc.GetDormUsers(&req)
	if err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *dormHandler) GetCapacityWarning(c *gin.Context) {
	res, err := h.svc.GetCapacityWarning()
	if err != nil {
		utils.Fail(c, err.Error())
		return
	}
