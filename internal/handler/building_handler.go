...
func (h *buildingHandler) GetListByPage(c *gin.Context) {
...
func (h *buildingHandler) GetDetail(c *gin.Context) {
	id := c.Query("id")
	if id == "" {
...
func (h *buildingHandler) GetBuildingsByCampus(c *gin.Context) {
	...
	res, err := h.svc.GetBuildingsByCampus(campusID)
	if err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *buildingHandler) ImportBuildings(c *gin.Context) {
	...
	count, err := h.svc.ImportBuildings(file)
	if err != nil {
		utils.Fail(c, err.Error())
		return
	}
...
func (h *buildingHandler) ExportBuildings(c *gin.Context) {
	var req dto.BuildingExportReq
	if !utils.ShouldBind(c, &req) {
		return
	}

	csvData, err := h.svc.ExportBuildings(&req)
	if err != nil {
		utils.Fail(c, err.Error())
		return
	}
